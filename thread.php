...
$nbComments = $queryPrepared2->rowCount();
...
if ($nbComments != 0) {
            ...
            <div class="col-8">
                <div class="card" style="width:800px">
                    <div class="card-header text-start">
                        <button type="button" class="userLikeButton" onclick="setLikeComment('.$userID.','.$comment['idThreadComment'].')">';if(hasLiked($userID,$comment['idThreadComment'])){echo '<img id="likeImage_'.$comment['idThreadComment'].'" src="./stylesheet/images/logo/liked.png">';}else{echo'<img id="likeImage_'.$comment['idThreadComment'].'" src="./stylesheet/images/logo/notLiked.png">';} echo'</button>
    ...
    echo '
        <div class="row pt-3 pb-2">
           ...
           <div class="col-sm">
              <div class="row">
                 <h4 class="text-center" style="color:aliceblue;">Aucun commentaire pour le moment...</h4>
                </div>
              <div class="row">
                 <img src="./stylesheet/images/threadImages/noCommentsYet.gif">
              </div>
            </div>
            <div class="col-sm"></div>
        </div>
