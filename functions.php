...
function sendVerifyMail($email,$username) {
	$to = $email;
	$subject = 'Confirmation de mail';
	$message = 'Bienvenue sur ARoots' . "\r\n" . 'Veuillez cliquez sur le lien suivant pour valider votre email : http://141.94.251.167/authentication/verifyMail?'.$username.'.php'. "\r\n" .'Cordalement,'. "\r\n" ."L'équipe AROOTS";
